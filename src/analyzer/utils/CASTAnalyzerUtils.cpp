...
AnalyzerUtils::findDataTypeInClass(clang::ASTContext &context, const clang::Decl *decl,
...
AnalyzerUtils::findMatchingMember(clang::ASTContext &context, const clang::Decl *decl,
                    const std::string &typeName) {
auto memberMatcher =
